...
//       <Card
//         key={index}
//         className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow p-4 sm:p-5 md:p-6 cursor-pointer h-full"
//       >
...
//               {stat.label}
//             </p>
//             <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 truncate">
//               {stat.value ?? 0}
//             </p>
//           </div>
...
//           {/* Icon Section */}
//           <div
//             className={`${stat.color} p-2 sm:p-3 rounded-lg text-white flex-shrink-0 flex items-center justify-center`}
//           >
...
//         </CardHeader>
//         <CardContent>
//           <p className="text-2xl font-semibold">{data?.activeOrders}</p>
//         </CardContent>
//       </Card>
//       <Card className="bg-white py-4 rounded-lg shadow-sm">
//         <CardHeader className="flex items-center justify-between">
...
//         </CardHeader>
//         <CardContent>
//           <p className="text-2xl font-semibold">{data?.totalTable}</p>
//         </CardContent>
//       </Card>
//       <Card className="bg-white py-4 rounded-lg shadow-sm">
//         <CardHeader className="flex items-center justify-between">
...
//         </CardHeader>
//         <CardContent>
//           <p className="text-2xl font-semibold">{data?.pendingOrder}</p>
//         </CardContent>
//       </Card>
//       <Card className="bg-white py-4 rounded-lg shadow-sm">
//         <CardHeader className="flex items-center justify-between">
...
//         </CardHeader>
//         <CardContent>
//           <p className="text-2xl font-semibold">{data?.cancelledOrder}</p>
//         </CardContent>
//       </Card>
//       <Card className="bg-white py-4 rounded-lg shadow-sm">
//         <CardHeader className="flex items-center justify-between">
...
//         </CardHeader>
//         <CardContent>
//           <p className="text-2xl font-semibold">{data?.tableBooking}</p>
//         </CardContent>
//       </Card>
//       <Card className="bg-white py-4 rounded-lg shadow-sm">
//         <CardHeader className="flex items-center justify-between">
...
//         </CardHeader>
//         <CardContent>
//           <p className="text-2xl font-semibold">{data?.totalInquiry}</p>
//         </CardContent>
//       </Card>
